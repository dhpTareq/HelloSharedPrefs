...
public class MainActivity extends AppCompatActivity {
    ...
    public void reset(View view) {
        ...
        //Initialize an editor to write in shared preference
     ...
     * Here save the value of current count value and
     * current color value
     * If the app is restarted this data will be restored
     */

    @Override
    protected void onPause() {
        super.onPause();
        //Initialize editor to write in shared preferences
